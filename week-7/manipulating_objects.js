...
// START: Oct 25, 2015 8:58 AM
// END: Oct 25, 2015 9:17 AM
...
- What tests did you have trouble passing? What did you do to make it pass? Why did that work?
    I didn't have any trouble passing tests. The only test that didn't pass was one that I had not written the code for.

- How difficult was it to add and delete properties outside of the object itself?
    Super easy, use . notation to add and delete to delete the properties.
